import { Stack,HStack, Button, Box, Flex, VStack,Image } from '@chakra-ui/react'
  ...
  return (
    <VStack gap='30px' mt='30px' spacing='0px'>
      <Flex gap='10px' direction='row' justify='center' align='center '  >
        ...
        <HStack wrap='wrap' justify='center' align='center' minWidth='80vw' minHeight='100vh' spacing='0px' gap='50px' marginTop='30px' backgroundColor='rgba(0, 0, 0,0.3)' padding='50px' borderRadius='30px' >
